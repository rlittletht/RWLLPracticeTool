    ...
    public partial class Practice : System.Web.Services.WebService
    {
        ...
        public class Teams : TCore.IQueryResult
        {
    		...
    		public class RwpTeam
			{
				...
				public string Division { get { return m_sDivision; } set { m_sDivision = value; } }
				public string Password { get { return m_sPassword; } set { m_sPassword = value; } }
				public DateTime? Created { get { return m_dttmCreated; } set { m_dttmCreated = value; } }
				public DateTime? Updated { get { return m_dttmUpdated; } set { m_dttmUpdated = value; } }
				public int FieldsReleased { get { return m_cFieldsReleased; } set { m_cFieldsReleased = value; } }
				public int CagesReleased { get { return m_cCagesReleased; } set { m_cCagesReleased = value; } }
				public int FieldsReleasedToday { get { return m_cFieldsReleasedToday; } set { m_cFieldsReleasedToday = value; } }
				public DateTime? ReleasedFieldsDate { get { return m_dttmReleasedFieldsDate; } set { m_dttmReleasedFieldsDate = value; } }
				public int CagesReleasedToday { get { return m_cCagesReleasedToday; } set { m_cCagesReleasedToday = value; } }
				public DateTime? ReleasedCagesDate { get { return m_dttmReleasedCagesDate; } set { m_dttmReleasedCagesDate = value; } }
                public string Email1 { get { return m_sEmail1; } set { m_sEmail1 = value; } }
                public string Email2 { get { return m_sEmail2; } set { m_sEmail2 = value; } }
    			...
    			public RwpTeam(SqlDataReader sqlr)
				{
					...
					m_dttmReleasedFieldsDate = sqlr.IsDBNull((int)iColumns.iReleasedFieldsDate) ? (DateTime?)null : sqlr.GetDateTime((int)iColumns.iReleasedFieldsDate) ;
                    m_cCagesReleasedToday = sqlr.GetInt32((int)iColumns.iCagesReleasedToday);
					m_dttmReleasedCagesDate = sqlr.IsDBNull((int)iColumns.iReleasedCagesDate) ? (DateTime?)null : sqlr.GetDateTime((int)iColumns.iReleasedCagesDate);
    		    ...
    		    public static string SGenRandomPassword(Random rnd, string sTeamName)
				{
                    ...
                    if (iNameFirst >= 0 && iNameLast >= 0 && iNameFirst + 2 < iNameLast && iNameLast + 2 < sTeamName.Length)
                        {
                        sPassword += sTeamName.Substring(iNameFirst + 1, 2).ToLower() + sTeamName.Substring(iNameLast + 1, 2).ToLower();
                        c = 4;
                        }
			...
			{
    		    readonly string[] m_rgsStaticHeaderTeams = new string[] {"TeamName", "Division", "PW", "DateCreated", "DateUpdated", "FieldsReleaseCount", "CagesReleaseCount", "ReleasedFieldsToday", "ReleasedFieldsDate", "ReleasedCagesToday", "ReleasedCagesDate", "Email1", "Email2" };
