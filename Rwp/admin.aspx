...
<tr>
    <td>
        <asp:Button ID="btnCreateTeam" runat="server" Text="Create Team" OnClick="DoShowCreateTeam"/>
    </td>
    <td>
        <p>
            Create a new team (and optional invitation code). You typically do this when you want to create a team inorder to get an invitation code to send to a user (so they can redeem the code to get automatically associated). You do NOT need to do this
            if you are going to use Add user/team below -- that will automatically create the team if it needs to
        </p>
    </td>
</tr>
<tr runat="server" id="rowCreateTeam" style="background: antiquewhite;">
    <td style="vertical-align: bottom">
        <asp:Button ID="btnDoCreateTeam" runat="server" Text="Add" OnClick="DoCreateTeam"/>
        <asp:Button ID="btnCancelCreateTeam" runat="server" Text="Cancel" OnClick="CancelCreateTeam"/>
    </td>
    <td>
        <nobr>
            <asp:CheckBox runat="server" id="chkCreateInvitationCode"/>
            Create Invitation Code?
        </nobr>
        <br/>
        <nobr>
            <asp:CheckBox runat="server" id="chkShowInvitationCode"/>
            Show Invitation code after adding team? (otherwise, you have to download teams.csv)
        </nobr>
        <br/>
        <nobr>
            <asp:CheckBox runat="server" id="chkUpdateTeam"/>
            Update Team? (overwrite any existing team data. BE CAREFUL!)
        </nobr>
        <br/>
        <nobr>
            Team Name:
            <asp:TextBox runat="server" id="txtCreateTeamName"></asp:TextBox>
        </nobr>
        <nobr>
            Division:
            <asp:TextBox runat="server" id="txtCreateTeamDivision" width=".25in"></asp:TextBox>
        </nobr>
    </td>
</tr>
<tr>
...
<tr runat="server" id="rowAddUser" style="background: antiquewhite;">
    <td style="vertical-align: bottom">
    ...
    <td>
        ...
        <nobr>
            Tenant:
            <asp:TextBox runat="server" id="txtAddTenant" width="3in">9188040d-6c67-4c5b-b112-36a304b66dad</asp:TextBox>
        </nobr>
        <nobr>
            Team Name:
...
<tr style="border-top: black 2pt solid">
    <td colspan="2">
        Notices/announcements on the home page:<br/>
        <table class="layout">
            <tr>
                <td>
